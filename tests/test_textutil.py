...
preprocessor = TextUtil("keywords")
...
keywords = [
    ...
    (
        "Agents",
        "the knowledge of any Borrower, Affiliates, employee, agent or representative of \
    ...
    (
        "Borrower",
        "The operations of each Borrower, and the activities of the officers and \
    directors and, to the knowledge of each Borrower, any Subsidiaries of the Borrowers,",
    ),
]
